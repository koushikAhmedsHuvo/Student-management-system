...
<ul> 
    ...
    <li><a href="logout.php">Logout</a></li>  
      ...
      <div class="row1" style="display:flex;justify-content:space-evenly;margin-top:15px;">
        ...
        <input style="width:250px;margin-left:0px;margin-top:0px;"  type="text" 
    ...
    <input class="button" type="submit" style="margin-top:0px; margin-left: 718px;" name="submit" value="Submit" class="submitButton">
