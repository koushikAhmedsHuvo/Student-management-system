...
<ul> 
    ...
    -->
      ...
      <div style="display:flex;justify-content:space-around;" class="row2">
        <button onclick="ploAnalysisWithDepartmentAverage()"  id="button_style">PLO Analysis with Department Average</button>
        <button onclick="ploAnalysisWithProgramAverage()" id="button_style">PLO Analysis with Program Average</button>
        <button onclick="ploAnalysisWithSchoolAverage()" id="button_style">PLO Analysis with School Average</button>
      </div>
...
if(isset($_POST['submit'])){
  ...
  <script>
    window.addEventListener('DOMContentLoaded', (event) => {
      ploAnalysisWithDepartmentAverage('<?php echo $studentID; ?>');
    });
  </script>
  <?php
}
