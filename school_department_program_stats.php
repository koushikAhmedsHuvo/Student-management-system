...
<ul> 
    ...
    <li><a class="pagePoint" href="">GPA Analysis</a>
...
<div class="background">
      ...
      <div  class="row1">
        <form method="POST">
         <select style="margin-left: 700px;" name="year" class="select">
      ...
      <div style="display:flex;justify-content:space-around;" class="row2">
        <button onclick="schoolWiseGpa()" id="button_style">School-wise GPA Trend</button>
        <button onclick="departmentWiseGpa()" id="button_style">Department-wise GPA Trend</button>
        <button onclick="programWiseGpa()" id="button_style">Program-wise GPA Trend</button>
      </div>
