...
<ul> 
    ...
    <li><a class="pagePoint" href="spiderChart.php">Spider Chart Analysis</a></li>
...
<!-- div row-1 starts here -->
     <div style="display:flex;justify-content:center ;padding-top:5px;" class="row1">
     <form method="POST">

     <input style="margin-left:20px;" class="input" type="text" placeholder="Enter Student ID" name="studentID"/>

    <input style="margin-bottom:0px;" class="button" type="submit" name="submit" value="Enter"/>
    ...
    <div style="display:flex;justify-content:center;margin-bottom:20px;">
        ...
        <button onclick="poView()" style="width:200px; margin-top:20px;" class="button">view PO analysis</button>
        <button onclick="coView()" style="width:200px; margin-top:20px" class="button">View CO analysis</button> 
